...
import { useDeleteBookMutation, useFetchAllBooksQuery } from '../../../redux/book/booksApi';
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 space-x-4">
                                                ...
                                                <button
                                                    ...
                                                    className="font-medium bg-red-500 py-1 px-4 rounded-full text-white mr-2">{`${book?._id}`} Delete</button>
                                            </td>
                                        </tr>
                                    ))
                                }
